...
public static final String ACTION_PATH_APPEND_BROADCAST =
	BuildConfig.TERM_APPLICATION_ID + ".broadcast.APPEND_TO_PATH";
public static final String ACTION_PATH_PREPEND_BROADCAST =
	BuildConfig.TERM_APPLICATION_ID + ".broadcast.PREPEND_TO_PATH";
