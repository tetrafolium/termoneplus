...
public class Process {
  ...
  public static int createSubprocess(ParcelFileDescriptor masterPty, String cmd,
  ...
  public static int waitExit(int pid) { return Native.waitExit(pid); }

  public static void finishChilds(int pid) { Native.finishChilds(pid); }

  private static class Native {
    private static native int createSubprocess(int ptm, byte[] path,
                                               byte[][] argv, byte[][] envp)
        throws IOException;
