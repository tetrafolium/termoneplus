...
public class TermService extends Service {
  ...
  private static final String NOTIFICATION_CHANNEL_APPLICATION =
      "com.termoneplus.application";
  ...
  public int getSessionCount() { return mTermSessions.size(); }
  ...
  private void addSession(TermSession session,
                          TermSession.FinishCallback callback) {
  ...
  private Notification buildNotification() {
    ...
    NotificationCompat.Builder builder =
        new NotificationCompat.Builder(this, NOTIFICATION_CHANNEL_APPLICATION)
    ...
    private static class Compat26 {
      private static void create(TermService service) {
        NotificationChannel channel = new NotificationChannel(
            NOTIFICATION_CHANNEL_APPLICATION, "TermOnePlus",
            NotificationManager.IMPORTANCE_LOW);
        channel.setDescription("TermOnePlus running notification");
        channel.setShowBadge(false);

        // Register the channel with the system ...
        // Note we can't change the importance or other notification behaviors
        // after this.
            ...
            new Handler(Looper.getMainLooper()).post(() -> {
              ...
              try {
                final TermSettings settings =
                    new TermSettings(getApplicationContext());
  ...
  private final class RBinderCleanupCallback
    ...
    public RBinderCleanupCallback(PendingIntent result,
