...
public class TermSettings {
  ...
  @IntDef(
      {ORIENTATION_UNSPECIFIED, ORIENTATION_LANDSCAPE, ORIENTATION_PORTRAIT})
  ...
  public void readPrefs(SharedPreferences prefs) {
    ...
    mActionBarMode =
        readIntPref("actionbar", mActionBarMode, ACTION_BAR_MODE_MAX);
    ...
    mColorId =
        readIntPref("color", mColorId, Settings.color_schemes.length - 1);
    ...
    mFnKeyId = readIntPref("fnkey", mFnKeyId, FN_KEY_SCHEMES.length - 1);
    ...
    mCloseOnExit =
        readBooleanPref("close_window_on_process_exit", mCloseOnExit);
  ...
  public int getScreenCalcMethod() { return mSizeCalc; }
  ...
  public void setHomePath(String homePath) { mHomePath = homePath; }
