...
public ShellTermSession(TermSettings settings, PathSettings path_settings,
...
private int createShellProcess(TermSettings settings,
...
throws IOException {
	...
	env[1] = "PATH=" + Application.xbindir.getPath() + File.pathSeparator +
	         path_settings.buildPATH();
