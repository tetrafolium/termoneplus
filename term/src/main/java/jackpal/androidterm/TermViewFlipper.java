...
public class TermViewFlipper extends ViewFlipper implements Iterable<View> {
  ...
  public void addCallback(UpdateCallback callback) { callbacks.add(callback); }
  ...
  public void onPause() { pauseCurrentView(); }

  public void onResume() { resumeCurrentView(); }
  ...
  private void showTitle() {
    ...
    if (mToast == null) {
      mToast = Toast.makeText(context.getApplicationContext(), title,
                              Toast.LENGTH_SHORT);
  ...
  public void setFullScreen(boolean flag) { full_screen = flag; }
}
