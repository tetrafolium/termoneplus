...
public class ColorValue {
  ...
  private SeekBar.OnSeekBarChangeListener seekbar_color =
      new SeekBar.OnSeekBarChangeListener() {
        ...
        public void onProgressChanged(SeekBar seekBar, int progress,
          ...
          color = Color.argb(data[0].color, data[1].color, data[2].color,
                             data[3].color);
  ...
  private CompoundButton.OnCheckedChangeListener lock_checked =
      (button, isChecked) -> {
    try {
  ...
  public ColorValue(Context context, final ImageView imgview,
                    final String result[]) {
    ...
    View view = LayoutInflater.from(context).inflate(
        R.layout.activity_color_value, null);
  ...
  private String colorAsHexString() { return String.format("#%08X", color); }
