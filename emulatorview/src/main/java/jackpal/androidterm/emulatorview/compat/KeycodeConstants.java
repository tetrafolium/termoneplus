 ...
 *
 * Contains the complete set of Android key codes that were defined as of
 * the 2.3 API. We could pull in the constants from the 2.3 API, but then we
 * would need to raise the SDK minVersion in the manifest. We want to keep
 * compatibility with Android 1.6, and raising this level could result in the
 * accidental use of a newer API.
 */
public class KeycodeConstants {
   ...
   * Deletes characters before the insertion point, unlike {@link
   * #KEYCODE_FORWARD_DEL}.
   */
   ...
   * interpreted as an ALT key by {@link
   ...
   * On a game controller, the L1 button should be either the button labeled L1
   * (or L) or the top left trigger button.
   */
  public static final int KEYCODE_BUTTON_L1 = 102;
  /**
   * Key code constant: R1 Button key.
   * On a game controller, the R1 button should be either the button labeled R1
   * (or R) or the top right trigger button.
   */
   ...
   * Deletes characters ahead of the insertion point, unlike {@link
   * #KEYCODE_DEL}.
   */
   ...
   * Navigates forward in the history stack.  Complement of {@link
   * #KEYCODE_BACK}.
   */
   ...
   * This key generally modifies the behavior of other keys on the numeric
   * keypad.
   */
   ...
   * This key should normally be implemented as a toggle such that the first
   * press
   ...
   * Switches the mode for closed-captioning text, for example during television
   * shows.
   */
