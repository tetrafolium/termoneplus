...
class TranscriptScreen implements Screen {
  ...
  public void setLineWrap(int row) { mData.setLineWrap(row); }
  ...
  public final void drawText(int row, Canvas canvas, float x, float y,
                             TextRenderer renderer, int cx, int selx1,
                             int selx2, String imeText, int cursorMode) {
    char[] line;
    StyleRow color;
    int cursorWidth = 1;
    try {
  ...
  public String getSelectedText(GrowableIntArray colors, int selX1, int selY1,
                                int selX2, int selY2) {
    return internalGetTranscriptText(colors, selX1, selY1, selX2, selY2);
  }

  private String internalGetTranscriptText(GrowableIntArray colors, int selX1,
   ...
   */
  boolean getScriptLineWrap(int row) { return mData.getLineWrap(row); }
